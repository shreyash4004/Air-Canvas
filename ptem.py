...
# Function to load a pre-trained model for character recognition
def load_char_recognition_model():
...
# Load a pre-trained model for character recognition
char_recognition_model = load_char_recognition_model()
...
while True:
    ...
    # If recognized_char exists, display it on the frame
    if 'recognized_char' in locals():
        cv2.putText(frame, recognized_char, (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
